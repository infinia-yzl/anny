...
|---|---|---|
| MakeHuman targets (`data/mpfb2/targets`) | The face-shape parameters (`face_shapes.json`) and the lip mask that places the lip landmarks | As the rest of the MakeHuman assets in anny (see `data/mpfb2/LICENSE.md`) |
| ICT Face Model Light, [ICT-FaceKit](https://github.com/USC-ICT/ICT-FaceKit) | The 3D identity space that anny's face shapes are fitted to | MIT licence. Li, R., Bladin, K., Zhao, Y., et al. *Learning Formation of Physically-Based Face Attributes*. CVPR 2020. |
